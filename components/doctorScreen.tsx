...
const DoctorDetailScreenComponent = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {doctor?.calendly ? (
        ...
        onPress={() => router.push({ pathname:'/(drawer)/(tabs)/stackhome/appointment', params: {calendly: doctor?.calendly || 'sin-cita', doctorIdParam: doctor?.doctorId || 'sin-id', doctorNameParam:doctor?.name || 'sin-nombre' } })}
      >
...
export default DoctorDetailScreenComponent;
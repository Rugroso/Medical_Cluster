...
export default function Weather({ loading, setLoading }: WeatherProps) {  const [temperature, setTemperature] = useState(0);
  ...
  useEffect(() => {
    fetch(
      "https://api.open-meteo.com/v1/forecast?latitude=32.4561&longitude=-114.7719&current=temperature_2m,weather_code,is_day,&models=gfs_seamless"
    )
  ...
  >
    ...
    {!loading && weatherAvailable && (
      <TouchableOpacity style={{ flexDirection: "column", alignItems: "flex-end" }} onPress={() => {Linking.openURL('https://weather.com/es-MX/tiempo/hoy/l/4cefff595fd4f7ce3f6c913dc51d53715584b747fcd7d1ea0773d2b90ad68275')}}>

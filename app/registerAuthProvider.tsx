...
export default function RegisterAuthProviderScreen() {
  const { registerwithGoogle } = useAuth()
  const router = useRouter()
  const params = useLocalSearchParams()
  
  // Obtener parámetros de la ruta
  const nameParam = params.nameParam as string || ""
  const emailParam = params.emailParam as string || ""
  const imageUrlParam = params.imageUrlParam as string || ""
  const uidParam = params.uidParam as string || ""
  ...
  const [profilePicture, setProfilePicture] = useState(imageUrlParam)
  ...
  // Cargar datos del proveedor de autenticación
  useEffect(() => {
    splitName()
  }, [nameParam])
        ...
        <ScrollView contentContainerStyle={styles.scrollView} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.formSection}>
            ...
            <Text style={{ textAlign: "center", color: "#666" }}>
              {profilePicture ? "Puedes cambiar tu foto de perfil si lo deseas." : "Selecciona una foto de perfil para tu cuenta."}
            </Text>
            ...
            <View style={styles.inputGroup}>
              ...
              <TextInput
                ...
                autoCapitalize="none"
                disabled={!!emailParam} // Deshabilitar si viene del proveedor
              />
              {emailParam && (
                <Text style={styles.infoText}>Este correo proviene de tu cuenta de Google y no puede ser modificado.</Text>
              )}
            </View>
